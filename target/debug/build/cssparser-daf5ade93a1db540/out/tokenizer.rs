use std :: char ; use std :: i32 ; use std :: ops :: Range ; use self :: Token :: * ; use cow_rc_str :: CowRcStr ; use parser :: ParserState ; # [ doc = " One of the pieces the CSS input is broken into." ] # [ doc = "" ] # [ doc = " Some components use `Cow` in order to borrow from the original input string" ] # [ doc = " and avoid allocating/copying when possible." ] # [ derive ( PartialEq , Debug , Clone ) ] pub enum Token < 'a > {
